...
import com.bloomreach.analyticssimulator.feed.ProcessedJsonlFeed;

public class TestProcessedFeed {
    ...
    public static void main(String[] args) {
        ...
        if ((args.length < 1)) {
            System.err.println ("Usage: ProcessedFeed <preProcessed_feed_filename>");
            return;
        }
 
        // ProcessedFeed feedProcessor = new ProcessedXMLFeed ();
        ProcessedFeed feedProcessor = new ProcessedJsonlFeed ();
        try {
