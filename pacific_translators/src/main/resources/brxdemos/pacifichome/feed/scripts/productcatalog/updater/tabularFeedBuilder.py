...
'''
    def _collectAllAttributes (self):
        ...
        for _aUpdatedProduct in self._updatedProducts:
            _productAttribs = _aUpdatedProduct ['value']['attributes']
            for attrib in _productAttribs.keys ():
                if (attrib in _masterDict) == False:
                    _masterDict [attrib] = ''

            if 'variants' in _aUpdatedProduct and _aUpdatedProduct ['variants']:
                _variantList = _aUpdatedProduct ['value']['variants']
