...
public class BuildWidgetViewEventPixel extends BuildPixelBase  {

    public BuildWidgetViewEventPixel () {
    }
    ...
    public int build (PixelBRData pixelData, 
        ...
        if (buildStatus == GeneratorConstants.GENERATE_STATUS_OK) {
            ...
            pixelData.setParam (PixelBRData.PARAMNAME_EVENT_ETYPE, PixelBRData.EVENT_ETYPE_WIDGET_VIEW);
            ...
            if (wq != null)
                pixelData.setParam (PixelBRData.PARAMNAME_WIDGET_WQ, wq);
            ...
            // update pixelCount
            updatePixelCountLog(PixelBRData.PIXEL_TYPE_EVENT, PixelBRData.EVENT_GROUP_WIDGET, PixelBRData.EVENT_ETYPE_WIDGET_VIEW);
