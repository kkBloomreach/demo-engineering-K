...
public class BuildSearchEventPixel extends BuildPixelBase  {
    ...
    public int build (PixelBRData pixelData, 
        ...
        if (buildStatus == GeneratorConstants.GENERATE_STATUS_OK) {
            ...
            pixelData.setParam (PixelBRData.PARAMNAME_EVENT_ETYPE, PixelBRData.EVENT_ETYPE_SUBMIT);
            ...
            // update pixelCount
            updatePixelCountLog(PixelBRData.PIXEL_TYPE_EVENT, PixelBRData.EVENT_GROUP_SUGGEST, PixelBRData.EVENT_ETYPE_SUBMIT);
