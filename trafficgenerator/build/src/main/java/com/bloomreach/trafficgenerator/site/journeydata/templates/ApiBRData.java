...
public class ApiBRData {
    ...
    // fllist must include attribs used in building API responseDoc (see Dispatch.java)
    public final static String DEFAULT_FL_LIST = "pid,price,title,sale_price,url,sku_thumb_image,skuid";
