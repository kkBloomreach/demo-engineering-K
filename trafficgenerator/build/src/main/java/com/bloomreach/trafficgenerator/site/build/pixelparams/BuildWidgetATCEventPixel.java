...
public class BuildWidgetATCEventPixel extends BuildPixelBase  {

    public BuildWidgetATCEventPixel () {
    }
    ...
    public int build (PixelBRData pixelData, 
        ...
        if (buildStatus == GeneratorConstants.GENERATE_STATUS_OK) {
            ...
            pixelData.setParam (PixelBRData.PARAMNAME_EVENT_GROUP, PixelBRData.EVENT_GROUP_CART); // group = 'cart' for widget-atc pixel

            // etype (aka action type)
            pixelData.setParam (PixelBRData.PARAMNAME_EVENT_ETYPE, PixelBRData.EVENT_ETYPE_WIDGET_ATC);
            ...
            if (skuid != null)
                pixelData.setParam (PixelBRData.PARAMNAME_WIDGET_SKU, skuid);
            ...
            // update pixelCount
            updatePixelCountLog(PixelBRData.PIXEL_TYPE_EVENT, PixelBRData.EVENT_GROUP_CART, PixelBRData.EVENT_ETYPE_WIDGET_ATC);
