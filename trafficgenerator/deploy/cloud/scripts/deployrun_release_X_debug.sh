...
CLSPATH=$WORK_DIR/lib/trafficgenerator-release-X.jar
...
java com.bloomreach.trafficgenerator.Generator -d $WORK_DIR/data -a $account -r prod -e release -t false -p false -l debug; \
