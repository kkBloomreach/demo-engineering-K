...
# java debug
java -agentlib:jdwp=transport=dt_socket,address=127.0.0.1:5005,server=y com.bloomreach.trafficgenerator.Generator -d $WORK_DIR/data  -a $account -l debug -r prod -t true -e dev -p false
