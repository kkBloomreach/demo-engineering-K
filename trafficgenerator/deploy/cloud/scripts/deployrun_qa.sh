...
CLSPATH=$WORK_DIR/lib/trafficgenerator-qa.jar
...
# java com.bloomreach.trafficgenerator.Generator -d $WORK_DIR/data -a $account -l debug -r prod  -t true -e qa -p false
java com.bloomreach.trafficgenerator.Generator -d $WORK_DIR/data -a $account -r prod -e qa -t false -p false -l debug
