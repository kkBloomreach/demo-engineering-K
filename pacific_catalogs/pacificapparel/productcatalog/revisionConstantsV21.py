...
FILENAME_AWS_DOWNLOAD_SCRIPT_OUT = './data/images/aws_image_download.sh'
FILENAME_AWS_UPLOAD_SCRIPT_OUT = './data/images/aws_image_upload.sh'
# S3 folder for orig product image
AWS_S3_ORIG_PRODUCT_IMAGES_FOLDER = 's3://pacific-demo-data.bloomreach.cloud/apparel/images/webp'
