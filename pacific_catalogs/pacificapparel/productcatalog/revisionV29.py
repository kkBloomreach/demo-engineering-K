...
# ---- basically, apply revisionV24_nik into this script (but using newer catalog.jsonl)
...
import revisionConstantsV29 as rcv29

class RevisionV29 (RevisionBase) :
    def __init__ (self):
        logging.info ('Perform update, version v29')
        super().__init__ ()
        return
...
if __name__ == '__main__':
    ...
    rv = RevisionV29()
    logging.info ('RevisionV29finish...')
