...
SITE_CONTENT_DOCUMENTS_API_ENDPOINT = 'https://pacific-saas.bloomreach.io/delivery/site/v2/documents?folder=/apparel/articles&limit=60'

FILENAME_UPDATED_JSONL_FEED_OUT = './data/output/pa_content_en_full_12162024.jsonl'
FILENAME_UPDATED_TSV_FEED_OUT = './data/output/pa_content_en_full_12162024.tsv'
FILENAME_UPDATED_FEED_ATTRIBUTELIST_OUT = './data/output/pa_content_en_full_12162024_attributes.txt'
FILENAME_INJECTED_AVMAP_OUT = './data/output/injected_avmap_12162024.tsv'
