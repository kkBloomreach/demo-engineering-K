...
SITE_CONTENT_DOCUMENTS_API_ENDPOINT = 'https://pacific-saas.bloomreach.io/delivery/site/v2/documents?folder=/home/articles&limit=60'

FILENAME_UPDATED_JSONL_FEED_OUT = './data/output/ph_content_en_full_12202024.jsonl'
FILENAME_UPDATED_TSV_FEED_OUT = './data/output/ph_content_en_full_12202024.tsv'
FILENAME_UPDATED_FEED_ATTRIBUTELIST_OUT = './data/output/ph_content_en_full_12202024_attributes.txt'
