...
if __name__ == '__main__':
    ...
    updatedProducts, updatedProducts_datahub, updatedAttributeList = updateDriver.perform_revision (revision_handler, sourceProducts, category_builder, inject_av_map)
