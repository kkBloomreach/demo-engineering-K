...
class RevisionV18 (RevisionBase) :
    ...
    def _read_adjust_titles_list (self):
        logging.info ("reading source: %s" % rcv18.FILENAME_ADJUST_TITLES_TSV_IN)
        adjust_titles = []
        if os.path.exists (rcv18.FILENAME_ADJUST_TITLES_TSV_IN):
            with open (rcv18.FILENAME_ADJUST_TITLES_TSV_IN, 'r') as file_obj:
            ...
            logging.error ('cannot find source: %s' % rcv18.FILENAME_ADJUST_TITLES_TSV_IN)
            adjust_titles = None
...
if __name__ == '__main__':
    ...
    rv = RevisionV18()
    logging.info ('RevisionV18finish...')
