# V23 changes
# -- clean up categories - same product included in each node in each branch
# -- change to: product included only in the leaf of each branch
...
if __name__ == '__main__':
    ...
    rv = RevisionV23()
    logging.info ('RevisionV23finish...')
