...
FILENAME_PSG_ENGLISH_SUBSET_JSONL_FEED_OUT = './data/output/psg_product_en_subset_04292026.jsonl'
FILENAME_PSG_ENGLISH_SUBSET_DATAHUB_JSONL_FEED_OUT = './data/output/psg_product_en_subset_datahub_04292026.jsonl'
FILENAME_PSG_ENGLISH_SUBSET_TSV_FEED_OUT = './data/output/psg_product_en_subset_04292026.tsv'
FILENAME_PSG_ENGLISH_SUBSET_FEED_ATTRIBUTELIST_OUT = './data/output/psg_product_en_subset_04292026.txt'
FILENAME_PSG_ENGLISH_SUBSET_INJECTED_AVMAP_OUT = './data/output/psg_injected_avmap_04292026.tsv'
