...
# -- obtain current content files using CMS api
# -- then adjust specific fields and generate dataconnect-style catalog file (.jsonl)
# -- Specifically, image urls changed to use copyright-free images (generated separately using openai)
...
class Revision (RevisionBase) :
    ...
    def _getCMSAttribValue (self, cms_record, attrib):
        ...
        # Therefore, no image mapping is needed in Discovery catalog either
            ...
            # image_url = self._lookup_image_url (cms_record ['path'])
