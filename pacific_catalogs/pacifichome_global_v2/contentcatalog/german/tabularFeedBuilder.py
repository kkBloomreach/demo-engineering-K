...
class TabularFeedBuilder ():
    ...
    def __init__ (self):
        self._updatedRecords = None
        self._updatedAttributeList = None
        return

    # updatedRecords in jsonl format
    def setUpdatedRecords (self, updatedRecords, updatedAttributeList): 
        self._updatedRecords = updatedRecords
    ...
    def _generateTabularRecords (self, masterDict):
        ...
        for _aUpdatedProduct in self._updatedRecords:
...
if __name__ == '__main__':
    ...
    _tabularFeed.setUpdatedRecords (None) 
