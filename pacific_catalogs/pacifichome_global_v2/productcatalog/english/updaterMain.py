...
class UpdateMain ():
    ...
    def loadSourceFeed (self):
        ...
        srcProducts = srcFeedHandler.readSourceFeed (uc.FILENAME_PH2_ENGLISH_JSONL_SOURCE_FEED_IN) 
        return srcProducts
    ...
    def writeJsonlFeed (self, updatedProducts):
        ...
        feedWriter.write (uc.FILENAME_PHG2_ENGLISH_UPDATED_JSONL_FEED_OUT)
        return
 
    def writeAttributesToFile (self, attributeList):
        # sort the list
        attributeList.sort ()
        savePath = uc.FILENAME_PHG2_ENGLISH_UPDATED_FEED_ATTRIBUTELIST_OUT
    ...
    def writeTabularFeed (self, tabularRecords):
        ...
        feedWriter.writeTSVFeed (uc.FILENAME_PHG2_ENGLISH_UPDATED_TSV_FEED_OUT)
        return

    def writeInjectedAVMap (self, injected_av_map):
        output_path = uc.FILENAME_PHG2_ENGLISH_INJECTED_AVMAP_OUT
...
if __name__ == '__main__':
    ...
    updatedProducts, updatedAttributeList = updateDriver.perform_revision (revision_handler, sourceProducts, inject_av_map)
