...
class UpdateMain ():
    ...
    def writeJsonlFeed (self, updatedProducts, format = 'dataconnect'):
        ...
        if format == 'dataconnect':
            feedWriter.write (uc.FILENAME_SAMPLE_NAB_JSONL_FEED_OUT)
        elif format == 'datahub':
            feedWriter.write (uc.FILENAME_SAMPLE_NAB_DATAHUB_JSONL_FEED_OUT)
        else:
    ...
    def writeAttributesToFile (self, attributeList):
        # sort the list
        attributeList.sort ()
        savePath = uc.FILENAME_SAMPLE_NAB_FEED_ATTRIBUTELIST_OUT
    ...
    def writeTabularFeed (self, tabularRecords):
        ...
        feedWriter.writeTSVFeed (uc.FILENAME_SAMPLE_NAB_TSV_FEED_OUT)
        return

    def writeInjectedAVMap (self, injected_av_map):
        output_path = uc.FILENAME_SAMPLE_NAB_INJECTED_AVMAP_OUT
